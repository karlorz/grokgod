...
if [ "$PIN_SHA" != "482711333c7195dc16a272777f86086d615e2afb" ]; then
  echo "FAIL: Expected PINNED_BASE_SHA to be 482711333c7195dc16a272777f86086d615e2afb, got $PIN_SHA" >&2
  exit 1
fi
